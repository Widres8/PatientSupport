...
public class StatusController {
    ...
    public ModelAndView list(){
        ...
        view.addObject("Status", _repository.findAll());
    ...
    public ModelAndView create(Status itemTocreate) {
    ...
    public ModelAndView store(@Valid Status itemTocreate, BindingResult result, Model model ) {
        ...
        try {
            ...
            view.setViewName("redirect:/status");
            return view;
    ...
    public ModelAndView edit(@PathVariable("id") Integer id,Model model ) {
        ...
        ModelAndView view = new ModelAndView();
        Status itemToEdit = findById(id);
        view.addObject("status", itemToEdit);
    ...
    public ModelAndView update(@PathVariable("id") Integer id, @Valid Status itemToEdit,BindingResult result, Model model) {
    ...
    public @ResponseBody String delete(@PathVariable("id") Integer id,Model model) {
        ...
        try {
            Status itemToDelete = findById(id);
    ...
    public @ResponseBody String enable(@PathVariable("id") Integer id, Model model) {
        try {
            Status itemToActive = findById(id);
     ...
     */
    private Status findById(int id) {
